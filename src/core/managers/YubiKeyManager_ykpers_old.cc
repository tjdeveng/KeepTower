...
/**
 * @brief APDU Command Builder for YubiKey operations
 *
 * YubiKey OTP Application APDU commands for HMAC Challenge-Response
 * Reference: https://developers.yubico.com/yubikey-manager/APDU.html
 */
namespace YubiKeyAPDU {
     ...
     * @return APDU command to select YubiKey OTP application
     */
