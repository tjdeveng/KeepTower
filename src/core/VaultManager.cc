...
// FIPS-140-3 management — thin wrappers; documentation lives in FipsProviderManager
bool VaultManager::init_fips_mode(bool enable) { return KeepTower::FipsProviderManager::init_fips_mode(enable); }
bool VaultManager::is_fips_available() { return KeepTower::FipsProviderManager::is_fips_available(); }
bool VaultManager::is_fips_enabled() { return KeepTower::FipsProviderManager::is_fips_enabled(); }
bool VaultManager::set_fips_mode(bool enable) { return KeepTower::FipsProviderManager::set_fips_mode(enable); }
