...
class VaultMetadata final :
 ...
 public:
  ...
  enum : int {
    ...
    kClipboardTimeoutSecondsFieldNumber = 8,
    kAccessCountFieldNumber = 7,
    kAutoLockTimeoutSecondsFieldNumber = 9,
    kUndoHistoryLimitFieldNumber = 11,
    kUndoRedoEnabledFieldNumber = 10,
    kAccountPasswordHistoryEnabledFieldNumber = 12,
    kAccountPasswordHistoryLimitFieldNumber = 13,
  };
  // string name = 5;
  void clear_name();
  const std::string& name() const;
  ...
  void clear_clipboard_timeout_seconds();
  int32_t clipboard_timeout_seconds() const;
  void set_clipboard_timeout_seconds(int32_t value);
  private:
  int32_t _internal_clipboard_timeout_seconds() const;
  void _internal_set_clipboard_timeout_seconds(int32_t value);
  public:
  ...
  void clear_auto_lock_timeout_seconds();
  int32_t auto_lock_timeout_seconds() const;
  void set_auto_lock_timeout_seconds(int32_t value);
  private:
  int32_t _internal_auto_lock_timeout_seconds() const;
  void _internal_set_auto_lock_timeout_seconds(int32_t value);
  public:

  // int32 undo_history_limit = 11;
  void clear_undo_history_limit();
  int32_t undo_history_limit() const;
  void set_undo_history_limit(int32_t value);
  private:
  int32_t _internal_undo_history_limit() const;
  void _internal_set_undo_history_limit(int32_t value);
  public:

  // bool undo_redo_enabled = 10;
  void clear_undo_redo_enabled();
  bool undo_redo_enabled() const;
  void set_undo_redo_enabled(bool value);
  private:
  bool _internal_undo_redo_enabled() const;
  void _internal_set_undo_redo_enabled(bool value);
  public:

  // bool account_password_history_enabled = 12;
  void clear_account_password_history_enabled();
  bool account_password_history_enabled() const;
  void set_account_password_history_enabled(bool value);
  private:
  bool _internal_account_password_history_enabled() const;
  void _internal_set_account_password_history_enabled(bool value);
  public:

  // int32 account_password_history_limit = 13;
  void clear_account_password_history_limit();
  int32_t account_password_history_limit() const;
  void set_account_password_history_limit(int32_t value);
  private:
  int32_t _internal_account_password_history_limit() const;
  void _internal_set_account_password_history_limit(int32_t value);
  public:
 ...
 private:
  ...
  int32_t clipboard_timeout_seconds_;
  int64_t access_count_;
  int32_t auto_lock_timeout_seconds_;
  int32_t undo_history_limit_;
  bool undo_redo_enabled_;
  bool account_password_history_enabled_;
  int32_t account_password_history_limit_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_src_2frecord_2eproto;
};
// -------------------------------------------------------------------
...
// int32 clipboard_timeout_seconds = 8;
inline void VaultMetadata::clear_clipboard_timeout_seconds() {
  clipboard_timeout_seconds_ = 0;
}
inline int32_t VaultMetadata::_internal_clipboard_timeout_seconds() const {
  return clipboard_timeout_seconds_;
}
inline int32_t VaultMetadata::clipboard_timeout_seconds() const {
  // @@protoc_insertion_point(field_get:keeptower.VaultMetadata.clipboard_timeout_seconds)
  return _internal_clipboard_timeout_seconds();
}
inline void VaultMetadata::_internal_set_clipboard_timeout_seconds(int32_t value) {
  
  clipboard_timeout_seconds_ = value;
}
inline void VaultMetadata::set_clipboard_timeout_seconds(int32_t value) {
  _internal_set_clipboard_timeout_seconds(value);
  // @@protoc_insertion_point(field_set:keeptower.VaultMetadata.clipboard_timeout_seconds)
}

// int32 auto_lock_timeout_seconds = 9;
inline void VaultMetadata::clear_auto_lock_timeout_seconds() {
  auto_lock_timeout_seconds_ = 0;
}
inline int32_t VaultMetadata::_internal_auto_lock_timeout_seconds() const {
  return auto_lock_timeout_seconds_;
}
inline int32_t VaultMetadata::auto_lock_timeout_seconds() const {
  // @@protoc_insertion_point(field_get:keeptower.VaultMetadata.auto_lock_timeout_seconds)
  return _internal_auto_lock_timeout_seconds();
}
inline void VaultMetadata::_internal_set_auto_lock_timeout_seconds(int32_t value) {
  
  auto_lock_timeout_seconds_ = value;
}
inline void VaultMetadata::set_auto_lock_timeout_seconds(int32_t value) {
  _internal_set_auto_lock_timeout_seconds(value);
  // @@protoc_insertion_point(field_set:keeptower.VaultMetadata.auto_lock_timeout_seconds)
}

// bool undo_redo_enabled = 10;
inline void VaultMetadata::clear_undo_redo_enabled() {
  undo_redo_enabled_ = false;
}
inline bool VaultMetadata::_internal_undo_redo_enabled() const {
  return undo_redo_enabled_;
}
inline bool VaultMetadata::undo_redo_enabled() const {
  // @@protoc_insertion_point(field_get:keeptower.VaultMetadata.undo_redo_enabled)
  return _internal_undo_redo_enabled();
}
inline void VaultMetadata::_internal_set_undo_redo_enabled(bool value) {
  
  undo_redo_enabled_ = value;
}
inline void VaultMetadata::set_undo_redo_enabled(bool value) {
  _internal_set_undo_redo_enabled(value);
  // @@protoc_insertion_point(field_set:keeptower.VaultMetadata.undo_redo_enabled)
}

// int32 undo_history_limit = 11;
inline void VaultMetadata::clear_undo_history_limit() {
  undo_history_limit_ = 0;
}
inline int32_t VaultMetadata::_internal_undo_history_limit() const {
  return undo_history_limit_;
}
inline int32_t VaultMetadata::undo_history_limit() const {
  // @@protoc_insertion_point(field_get:keeptower.VaultMetadata.undo_history_limit)
  return _internal_undo_history_limit();
}
inline void VaultMetadata::_internal_set_undo_history_limit(int32_t value) {
  
  undo_history_limit_ = value;
}
inline void VaultMetadata::set_undo_history_limit(int32_t value) {
  _internal_set_undo_history_limit(value);
  // @@protoc_insertion_point(field_set:keeptower.VaultMetadata.undo_history_limit)
}

// bool account_password_history_enabled = 12;
inline void VaultMetadata::clear_account_password_history_enabled() {
  account_password_history_enabled_ = false;
}
inline bool VaultMetadata::_internal_account_password_history_enabled() const {
  return account_password_history_enabled_;
}
inline bool VaultMetadata::account_password_history_enabled() const {
  // @@protoc_insertion_point(field_get:keeptower.VaultMetadata.account_password_history_enabled)
  return _internal_account_password_history_enabled();
}
inline void VaultMetadata::_internal_set_account_password_history_enabled(bool value) {
  
  account_password_history_enabled_ = value;
}
inline void VaultMetadata::set_account_password_history_enabled(bool value) {
  _internal_set_account_password_history_enabled(value);
  // @@protoc_insertion_point(field_set:keeptower.VaultMetadata.account_password_history_enabled)
}

// int32 account_password_history_limit = 13;
inline void VaultMetadata::clear_account_password_history_limit() {
  account_password_history_limit_ = 0;
}
inline int32_t VaultMetadata::_internal_account_password_history_limit() const {
  return account_password_history_limit_;
}
inline int32_t VaultMetadata::account_password_history_limit() const {
  // @@protoc_insertion_point(field_get:keeptower.VaultMetadata.account_password_history_limit)
  return _internal_account_password_history_limit();
}
inline void VaultMetadata::_internal_set_account_password_history_limit(int32_t value) {
  
  account_password_history_limit_ = value;
}
inline void VaultMetadata::set_account_password_history_limit(int32_t value) {
  _internal_set_account_password_history_limit(value);
  // @@protoc_insertion_point(field_set:keeptower.VaultMetadata.account_password_history_limit)
}
